 ...
 * @author KHOULOUD
 */
public class PapierController implements Initializable {

    @FXML
    private TableColumn<papier, String> tablenometprenom;
    @FXML
    private TableColumn<papier, String> table_type;
    @FXML
    ...
    private void afficherP(ActionEvent event) {
         PapierCRUD c=new  PapierCRUD ();
        ArrayList<papier> papiers;
        papiers = (ArrayList<papier>) c.afficherPapier();
        ObservableList obs = FXCollections.observableArrayList(papiers);
        table_P.setItems(obs);
        tablenometprenom.setCellValueFactory(new PropertyValueFactory<>("nomE"));
        table_type.setCellValueFactory(new PropertyValueFactory<>("typeP"));
    }
